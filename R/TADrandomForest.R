...
#' is list(mtry=ceiling(sqrt(ncol(trainData)-1)), ntree=500, nodesize=1). If
#' multiple values are provided then a grid search is performed to tune the
#' model.
...
#' @param model Logical, whether to keep the model object
