...
The Hela-S3-specific TFBS data can be downloaded at [ENCODE]() [??? Add more detailed link. Can you read BED files directly from ENCODE URLs?] or read from the [supplementary repository]( https://github.com/stilianoudakis/preciseTAD_supplementary/tree/master/data/bed/hela) [??? To use ExperimentHub]. They can be converted into a GRangesList.
