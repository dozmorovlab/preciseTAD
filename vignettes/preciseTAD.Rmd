...
As an example, we consider the Hela-S3 cell line. We will download and use the [???](link) model to predict boundaries for chr22 in the Hela-S3 cell line.

```{r, eval=FALSE}
# Read in RF model built on chr1-chr21
tadModel <- readRDS("~/Documents/nobackup/tadRF_CHR22_holdout_gm12878_peakachu_gt.rds")
```
